...
const VideoFeed = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-purple-100 via-white to-gray-100">
      <div className="bg-white rounded-xl shadow-lg px-8 py-12 flex flex-col items-center">
        {/* Icon */}
        <svg className="w-16 h-16 text-purple-400 mb-6" fill="none" viewBox="0 0 64 64">
          <circle cx="32" cy="32" r="28" fill="#F3E8FF" />
          <path d="M32 20v16M32 44h.02" stroke="#A78BFA" strokeWidth="4" strokeLinecap="round" />
        </svg>
        {/* Message */}
        <h1 className="text-3xl font-bold mb-4 text-gray-800">Coming Soon</h1>
        <p className="text-gray-500 mb-6">We’re working hard to bring you something amazing.</p>
        {/* Animated Dots */}
        <div className="flex space-x-2">
          <span className="animate-bounce inline-block w-2 h-2 bg-purple-400 rounded-full"></span>
          <span className="animate-bounce inline-block w-2 h-2 bg-purple-400 rounded-full animation-delay-150"></span>
          <span className="animate-bounce inline-block w-2 h-2 bg-purple-400 rounded-full animation-delay-300"></span>
        </div>
      </div>
    </div>
  );
